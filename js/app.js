...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    // images fix in src and add rating
    div.innerHTML = `<div class="single-product">
      ...
      <h5> Rating:<i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half"></i> ${product.rating.rate}</h5>
...
const updatePrice = (id, value) => {
  ...
  document.getElementById(id).innerText = (Math.round(total* 100)/100).toFixed(2);      //problem -- decimal up to 2 numbers
};
